...
Dette prosjektet er en bankapplikasjon utviklet i JavaFX som skal gi brukeren mulighet til å adminstrere sine bankkontoer. For mer informasjon om hvordan appen fungerer, se [`bank/readme.md`](bank/readme.md).
